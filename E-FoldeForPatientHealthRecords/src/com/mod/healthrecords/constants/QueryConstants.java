...
public class QueryConstants {
	...
	public static final String GET_PHR_DETAILS_BY_PATIENT_ID_AND_PHR_TYPE="select p.PHR_ID,PATIENT_ID,p.DOCTOR_ID,to_char(TO_TIMESTAMP(p.PHR_UPLOADED_DATE),'YYYY-MM-DD HH:MI:SS'), p.PHR_TYPE,p.PHR_UPLOADED_PATH_ORIGINAL,p.PHR_UPLOADED_PATH_PDF,p.PHR_DESCRIPTION,d.DOCTOR_NAME,d.DOCTOR_SPECIALIZATION,p.PATIENT_PRESCRIPTION,IS_DELIVERED,payment_status from phr_tab p, doctors_tab d where p.doctor_id=d.doctor_id and p.patient_id=? and p.phr_type=? order by p.PHR_ID desc";
	...
	public static final String GET_ALL_REPORTS_BY_PATIENT_ID="select p.PHR_ID,PATIENT_ID,p.DOCTOR_ID,to_char(TO_TIMESTAMP(p.PHR_UPLOADED_DATE),'YYYY-MM-DD HH:MI:SS'), p.PHR_TYPE,p.PHR_UPLOADED_PATH_ORIGINAL,p.PHR_UPLOADED_PATH_PDF,p.PHR_DESCRIPTION,d.DOCTOR_NAME,d.DOCTOR_SPECIALIZATION,p.PATIENT_PRESCRIPTION,IS_DELIVERED,payment_status from phr_tab p, doctors_tab d where p.doctor_id=d.doctor_id and p.patient_id=? order by p.PHR_ID desc";
