...
public class PhrmacyServiceURIConstants {
	...
	public static final String GET_ORDER_BY_ORDERID_URL="http://localhost:8085/ParmacyService/phrmacyProvider/getOrderByOrderId/{pharmacyId}/{orderId}";
	...
	public static final String SEND_SMS_PRESCRIPTION_URL="http://2factor.in/API/V1/e9c55599-05c3-11e8-a328-0200cd936042/ADDON_SERVICES/SEND/TSMS";
}
